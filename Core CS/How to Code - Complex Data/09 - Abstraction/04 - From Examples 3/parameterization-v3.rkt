...
(check-expect (map2 string-length (list "t" "tr" "tri" "trip")) (list 1 2 3 4))
...
;; produce the list of all elements from the given list that satisfies the given predicate/condition
